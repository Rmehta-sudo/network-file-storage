...
**Key Points:**
- [PASS] Multiple clients can READ the same file simultaneously
-  Access requests live on the Name Server disk; owners review them asynchronously
...
- [PASS] Multiple clients can WRITE different sentences in the same file simultaneously
- [FAIL] Only ONE client can WRITE to a specific sentence at a time (sentence-level locking)
...
[PASS] File 'report.txt' created successfully!

alice@docs++ > WRITE report.txt 0
[OK] Acquired write lock for 'report.txt' sentence 0
...
[PASS] Access granted to 'bob': Read, Write

bob@docs++ > WRITE report.txt 1
[OK] Acquired write lock for 'report.txt' sentence 1
   Current word count: 0
Enter updates in format: <word_index> <content>
Type 'ETIRW' to commit and release lock
...
[FAIL] Error: No write access to file
   Code: ERR_NO_ACCESS
...
[FAIL] Error: Sentence is already locked by another client
   Code: ERR_SENTENCE_LOCKED

alice@docs++ > WRITE report.txt 2
[OK] Acquired write lock for 'report.txt' sentence 2
   Current word count: 0
Enter updates in format: <word_index> <content>
Type 'ETIRW' to commit and release lock
...
|-----------|-----------------|-----------|---------------|
| **READ** | [PASS] Unlimited | [PASS] Yes | [PASS] Yes |
| **CREATE** | [PASS] Unlimited | [FAIL] No | N/A |
| **DELETE** | [PASS] Yes (owner only) | N/A | N/A |
| **WRITE** | [PASS] Yes | [PASS] Yes | [FAIL] No (locked) |
| **INFO** | [PASS] Unlimited | [PASS] Yes | [PASS] Yes |
| **LIST** | [PASS] Unlimited | N/A | N/A |
| **VIEW** | [PASS] Unlimited | N/A | N/A |
